...
def mirror_reflectivity(
    ...
    single_bounce = np.clip(single_bounce * aging_factor, 0.0, 1.0)
    return single_bounce**n_refl
...
def throughput_components(
    ...
    mirror = mirror_reflectivity(wavelength_nm, config.mirror_coating, config.n_reflections)
